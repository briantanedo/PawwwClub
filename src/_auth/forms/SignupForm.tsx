...
const SignupForm = () => {
  ...
  return (
    <div className="flex flex-col bg-white items-center justify-center p-8 rounded-lg drop-shadow-lg">      
      <Form {...form}>
        <div className="w-full flex-center flex-col">
          <img src="/assets/images/logo.svg" className="w-60"/>

          <h2 className="h3-bold md:h2-bold pt-5">Create a new account</h2>
          <p className="text-dark-1 small-medium md:base-regular mt-2"> To use PawwwClub enter your account details</p>
        </div>
